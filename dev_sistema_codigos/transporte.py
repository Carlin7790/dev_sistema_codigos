class Veiculo:
    ...
    def detalhes(self):
        print(f'Esse veiculo e da marca: {self.__marca}, do modelo: {self.__modelo}, da cor: {self.__cor} e do ano: {self.__ano}')
...
class Carro(Veiculo):
    ...
    def acelerar(self):
        print(f'Andando de {self.getModelo()} por ai')

carro1 = Carro('BYD',' Dolphin Mini', 'Cinza', 2025, 4)
carro2 = Carro('VW','GolF G3','Cinza',1998,2)
carro1.detalhes()
carro2.acelerar()
